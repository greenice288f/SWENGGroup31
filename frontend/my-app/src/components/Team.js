        ...
        <ul class="team-card-group">
          ...
          <li class="team-item">
            ...
            <div class="team-info">
              ...
              <span class="team-job">Frontend lead</span>
            </div>
          </li>
          ...
          <li class="team-item">
            ...
            <div class="team-info">
              ...
              <span class="team-job">Backend lead</span>
            </div>
          </li>
          ...
          <li class="team-item">
            <picture class="team-picture">
              <img
                ...
                loading="lazy"
                decoding="async"
                src="/photos/Screenshot 2024-03-27 at 18.14.56.png"
                alt="Frontend"
                width="105"
                height="135"
              ></img>
